# 🌟 Chiller-Driver-Test-Automation
...
## 🔄 진행과정
1. **요구사항 분석 및 설계**: 초기 단계에서는 프로젝트의 기본 요구사항을 분석하고, 시스템의 기본 설계를 수립하였습니다.
2. **시스템 개발 및 테스트**: 본격적인 개발을 시작하여 각 하드웨어 및 소프트웨어 컴포넌트의 통합 테스트를 진행하였습니다.
3. **성능 평가 및 최적화**: 개발된 시스템의 성능을 평가하고, 필요에 따라 추가적인 최적화 작업을 수행하였습니다.
4. **사용자 피드백 및 마무리 작업**: 최종 사용자로부터 피드백을 받고, 프로젝트 결과물을 마무리하였습니다.
...
1. 하드웨어의 구성품 및 조립영상을 참고하여 하드웨어 조립을 실시하였습니다.
2. 하드웨어의 조립이 끝난 후 Power supply 및 모터를 부착했습니다.
